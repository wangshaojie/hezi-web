    ...
    >
      <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <!-- 移动端搜索按钮 -->
          <button
            class="md:hidden p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
    ...
    <main class="container mx-auto px-4 py-8">
      ...
      <div class="mb-8 overflow-x-auto pb-2">
        <div class="flex gap-2 min-w-max">
          ...
          <button
            @click="activeCategory = 'productivity'"
            class="px-4 py-2 rounded-full text-sm font-medium transition-all duration-300"
            :class="
              ...
              <div class="p-4 pb-6 flex-grow flex flex-col">
                ...
                <div class="mt-auto pt-2">
                  ...
                  >
                    访问网站
                    <i
                      class="fas fa-arrow-right ml-1 transform group-hover:translate-x-1 transition-transform"
                    ></i>
                  </span>
                </div>
              </div>
